              ...
              <CardContent>
                <div className="grid grid-cols-4 gap-4">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-600">Frotas</div>
                  </div>
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-600">Lâmina Alvo</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-orange-600">{formData.total_viagens_feitas}</div>
                    <div className="text-sm text-gray-600">Viagens Feitas</div>
                  </div>
                </div>
              </CardContent>
            </Card>
