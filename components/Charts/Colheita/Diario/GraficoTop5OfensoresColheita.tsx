...
interface GraficoTop5OfensoresColheitaProps {
  data?: OfensorData[];
}

export const GraficoTop5OfensoresColheita: React.FC<GraficoTop5OfensoresColheitaProps> = ({ data }) => {
...
export default GraficoTop5OfensoresColheita; 