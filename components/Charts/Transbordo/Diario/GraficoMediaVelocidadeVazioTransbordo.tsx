...
interface GraficoMediaVelocidadeVazioProps {
  data: VelocidadeData[];
  meta?: number;
...
export const GraficoMediaVelocidadeVazioTransbordo: React.FC<GraficoMediaVelocidadeVazioProps> = ({ 
  data = [],
...
export default GraficoMediaVelocidadeVazioTransbordo; 